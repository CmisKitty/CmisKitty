//
//  CKRepositoryInfoViewController.m
//  CKBrowser
//
...
@implementation CKRepositoryInfoViewController
...
- (void)viewDidLoad
{
    ...
    [manager.objectManager getObject:self.repository delegate:self];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = self.repository.productVersion;
...
- (void)objectLoader:(RKObjectLoader *)objectLoader didLoadObject:(id)object{
    ...
    self.repository = (CKRepository *)object;
